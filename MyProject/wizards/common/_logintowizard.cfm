...
<cfif isRdsUserRequired>
  <cfset focus = "document.forms.loginform.rdsUserId.focus();">
<cfelse>
...
<table width="570" border="0" cellspacing="0" cellpadding="0" align="center" background="#request.thisURL#images/componentutilslogin.jpg">
		<tr>
		...
		<tr>
			...
			<td align="left">
				...
				<cfif isRdsUserRequired>
					...
					<!---<cfif IsDefined("FORM.rdsUserId")>
						<input name="rdsUserId" type="text" size="15" maxlength="100" id="admin_login_id" value="#FORM.rdsUserId#" autocomplete="off" style="width:300px; padding-left:5px;"><br/>
					<cfelse>
	...
	<td colspan="2">
		<table border="0" cellpadding="0" cellspacing="0">
			<tr>
				...
				<td style="width:500px;"><p style="margin:20px 20px 20px 20px;" class="loginCopyrightText"><admin:l10n id="copyright_cont">Adobe, the Adobe logo, ColdFusion, and Adobe ColdFusion are trademarks or registered trademarks of Adobe Systems Incorporated in the United States and/or other countries.  All other trademarks are the property of their respective owners.</admin:l10n></p>
				</td>
			</tr>
		</table>
		<br />
